...
<div class="main content w-full bg-white rounded-lg shadow-md p-6">
    ...
    <div class="mb-6 flex space-x-3 overflow-x-auto scrollbar-thin no-scrollbar-safari">
      ...
      <button class="flex-shrink-0 px-4 py-1.5 font-semibold rounded-full border border-blue-500 text-blue-600 bg-blue-100 focus:outline-none" aria-current="true">Leg</button>   
    ...
    >
      ...
      <a href="Leg-beginner.php" class="no-underline">
  <!-- Abs Beginner -->
  <div class="snap-start min-w-[300px] flex-shrink-0 flex items-center space-x-4 bg-gray-50 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer select-none">
    ...
    />
    <div>
      <h3 class="font-bold text-lg text-gray-900">Legs Beginner</h3>
      <p class="text-gray-500 mt-1 text-sm">45 - 50 mins · 5 Exercises</p>
      ...
      <a href="Leg-intermediate.php" class="no-underline">
  <!-- Abs Intermediate -->
  <div
  ...
  >
    ...
    />
    <div>
      <h3 class="font-bold text-lg text-gray-900">Legs Intermediate</h3>
      ...
      <a href="Leg-advanced.php" class="no-underline">
  <!-- Abs Advanced -->
  <div
    class="snap-start min-w-[300px] flex-shrink-0 flex items-center space-x-4 bg-gray-50 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer select-none"
  >
    ...
    />
    <div>
      <h3 class="font-bold text-lg text-gray-900">Legs Advanced</h3>
