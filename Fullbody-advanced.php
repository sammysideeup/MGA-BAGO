...
<main class="bg-white rounded-2xl  w-full drop-shadow-lg select-none"
  ...
  >
    <section class="p-6">
      ...
      <h1 class="text-2xl font-bold leading-tight mb-6">Full Body Advanced</h1>
...
<script>
  ...
  items.forEach(li => {
    ...
    const exercises = [
      ...
      {
        id: "barbell-curl-tricep-rope-pushdown",
        name: "Barbell Curl Tricep Rope Pushdown",
        sets: 3,
        reps: "12x",
        gif: "WorkoutGifs/.gif",
        img: 
