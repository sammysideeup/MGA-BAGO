...
<main class="bg-white rounded-2xl  w-full drop-shadow-lg select-none"
  ...
  >
    <section class="p-6">
      <a href="Arm.php" class="back-icon"><i class='bx bx-arrow-back'></i></a>
      <h1 class="text-2xl font-bold leading-tight mb-6">Arms Advanced</h1>
      <div class="flex gap-4 mb-8">
        <div
          class="flex-1 bg-gray-100 rounded-xl p-4 text-center shadow-inner"
          aria-label="Duration"
        >
          <p class="text-lg font-semibold text-gray-900">70 - 80 mins</p>
...
<script>
  ...
  items.forEach(li => {
    ...
    const exercises = [
      ...
      {
        id: "tricep-rope-pushdown-overhead-superset",
        name: "Tricep Rope Pushdown + Overhead Superset",
        sets: 3,
        reps: "12x",
        gif: "WorkoutGifs/.gif",
        img: 
      ...
      {
        id: "one-arm-cable-tricep-extension",
