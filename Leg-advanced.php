...
<main class="bg-white rounded-2xl  w-full drop-shadow-lg select-none"
  ...
  >
    <section class="p-6">
      <a href="Leg.php" class="back-icon"><i class='bx bx-arrow-back'></i></a>
      <h1 class="text-2xl font-bold leading-tight mb-6">Leg advanced</h1>
...
<script>
  ...
  items.forEach(li => {
    ...
    const exercises = [
      ...
      {
        id: "walking-lunge-calf-raises",
        name: "Walking Lunge + Calf Raises",
        sets: 3,
        reps: "12x steps",
        gif: "WorkoutGifs/.gif",
        img: 
