...
<main class="bg-white rounded-2xl  w-full drop-shadow-lg select-none"
  ...
  >
    <section class="p-6">
      <a href="Chest.php" class="back-icon"><i class='bx bx-arrow-back'></i></a>
      <h1 class="text-2xl font-bold leading-tight mb-6">Chest Advanced</h1>
      <div class="flex gap-4 mb-8">
        <div
          class="flex-1 bg-gray-100 rounded-xl p-4 text-center shadow-inner"
          aria-label="Duration"
        >
          <p class="text-lg font-semibold text-gray-900">75 - 90 mins</p>
    ...
    const exercises = [
      {
        ...
        name: "Barbell Bench Press (Pyramid Set)",
        sets: 4,
        reps: "15x",
        gif: "WorkoutGifs/.gif",
        img: 
      ...
      {
        id: "cable-fly-push-ups",
        name: "Cable Fly + Push-Ups",
        sets: 3,
        reps: "15x",
        gif: "WorkoutGifs/.gif",
        img: 
...

      {
        ...
        name: "Isometric Push-Up Hold (Burnout)",
        sets: 2,
        reps: "Hold 20-30 secs",
        gif: "WorkoutGifs/.gif",
        img: 
          `<svg width="48" height="48" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
