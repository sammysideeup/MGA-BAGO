...
<main class="bg-white rounded-2xl  w-full drop-shadow-lg select-none"
  ...
  >
    <section class="p-6">
      ...
      <h1 class="text-2xl font-bold leading-tight mb-6">Abs Beginner</h1>
      <div class="flex gap-4 mb-8">
        <div
          class="flex-1 bg-gray-100 rounded-xl p-4 text-center shadow-inner"
          aria-label="Duration"
        >
          <p class="text-lg font-semibold text-gray-900">30 - 40 mins</p>
      ...
      <button id="start-button" class="mt-4 p-2 bg-blue-500 text-white rounded">Start Workout</button>    <!-- ADD THIS -->

      <h2 class="text-lg font-semibold mb-3">Exercises</h2>  <!-- Start Button -->
...
<script>
  ...
  items.forEach(li => {
    ...
    const exercises = [
      ...
      {
        id: "roman-chair-knee-raises",
        name: "Roman Chair Knee Raises",
        sets: 3,
        reps: "10-12x",
        gif: "WorkoutGifs/.gif",
        img: 
