...
<main class="bg-white rounded-2xl  w-full drop-shadow-lg select-none"
  ...
  >
    <section class="p-6">
      ...
      <h1 class="text-2xl font-bold leading-tight mb-6">Abs Advanced</h1>
      <div class="flex gap-4 mb-8">
        <div
          class="flex-1 bg-gray-100 rounded-xl p-4 text-center shadow-inner"
          aria-label="Duration"
        >
          <p class="text-lg font-semibold text-gray-900">40 - 50 mins</p>
...
<script>
  ...
  items.forEach(li => {
    ...
    const exercises = [
      {
        id: "hanging-straight-leg-raises",
      ...
      {
        id: "weighted-decline-sit-up-with-twist",
        name: "Weighted Decline Sit-Up With Twist",
        sets: 4,
        reps: "10x each side",
        gif: "WorkoutGifs/.gif",
        img: 
      ...
      {
        id: "ad-cable-crunch-heavy-pause",
        name: "Ad Cable Crunch (Heavy) + Pause",
        sets: 4,
        reps: "10x",
        gif: "WorkoutGifs/.gif",
        img: 
      ...
      {
        id: "cable-oblique-twists",
        name: "Cable Oblique Twists",
        sets: 3,
        reps: "12x each side",
        gif: "WorkoutGifs/.gif",
        img: 
      ...
      {
        id: "toe-touches-pulse-crunch",
        name: "Toe Touches + Pulse Crunch",
        sets: 3,
        reps: "15x",
        gif: "WorkoutGifs/.gif",
        img: 
